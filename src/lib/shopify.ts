// Pulled from https://github.com/vercel/sveltekit-commerce/blob/main/src/utils/shopify.js
// Thanks Lee!

export async function shopifyFetch({ query, variables }) {
	const endpoint =
		import.meta.env.VITE_SHOPIFY_API_ENDPOINT ||
		'https://groovy-basement.myshopify.com/api/2021-10/graphql.json';
	const key =
		import.meta.env.VITE_SHOPIFY_STOREFRONT_API_TOKEN || '1528b6c22afcde2f4c0ce87837a12955';
